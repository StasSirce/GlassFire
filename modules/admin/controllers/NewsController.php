...
/**
 * NewsController Реализовывает CRUD для модели News.
 */
class NewsController extends Controller
 {
    ...
    /**
     * Отображает все записи модели News.
     * @return mixed
     */
    public function actionIndex() {
        ...
        return $this->render('index', [
            ...
            'title' =>  News::name(["МН","ИМ"])
        ]);
    }

    /**
     * Показывает одну запись модели News.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Создает запись запись модели News.
    ...
    /**
     * Обновляет существующую запись модели News.
    ...
    /**
    * Показывать измеения в модели News.
    * @param integer $id
    * @return mixed
    */
    ...
    /**
     * Находит запись в модели News основыаясь на внешнем ключе.
     * Если запись не найдена, выбрасывает ошибку 404.
     * @param integer $id
     * @return News найденная запись

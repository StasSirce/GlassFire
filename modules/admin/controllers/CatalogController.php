...
/**
 * CatalogController Реализовывает CRUD для модели Catalog.
 */
class CatalogController extends Controller
 {
    ...
    /**
     * Отображает все записи модели Catalog.
     * @return mixed
     */
    ...
    /**
     * Создает запись запись модели Catalog.
    ...
    /**
     * Обновляет существующую запись модели Catalog.
    ...
    /**
    * Показывать измеения в модели Catalog.
    * @param integer $id
    * @return mixed
    */
    ...
    /**
     * Удаляет запись из модели Catalog.
    ...
    /**
     * Находит запись в модели Catalog основыаясь на внешнем ключе.
     * Если запись не найдена, выбрасывает ошибку 404.
     * @param integer $id
     * @return Catalog найденная запись
